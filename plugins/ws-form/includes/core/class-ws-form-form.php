				...
				foreach($if as $key_if => $group) {
					...
					foreach($conditions as $key_condition => $condition) {
						...
						if(
							...
							// Straight swap - Value
							if(isset($this->new_lookup[$condition->object][$condition->value])) {
								...
								if(
									...
									$condition->value = $this->new_lookup[$condition->object][$condition->value];
								}
							}
						}
						...
						foreach($this->new_lookup['field'] as $field_id_old => $field_id_new) {
							...
							if(isset($condition->value)) {
								...
								foreach($parse_variables_repairable['field'] as $parse_variable) {
									...
									$condition->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ')', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ')' : '', $condition->value);
									$condition->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ',', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ',' : '', $condition->value);
								}
							}
						}
						...
						foreach($this->new_lookup['section'] as $section_id_old => $section_id_new) {
							...
							if(isset($condition->value)) {
								...
								foreach($parse_variables_repairable['section'] as $parse_variable) {
									...
									$condition->value = str_replace('#' . $parse_variable . '(' . $section_id_old . ')', ($section_id_new != '') ? '#' . $parse_variable . '(' . $section_id_new . ')' : '', $condition->value);
								}
							}
						}
					}
					...
					foreach($this->new_lookup['field'] as $field_id_old => $field_id_new) {
						...
						if(isset($then_single->value)) {
							...
							foreach($parse_variables_repairable['field'] as $parse_variable) {
								...
								$then_single->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ')', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ')' : '', $then_single->value);
								$then_single->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ',', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ',' : '', $then_single->value);
							}
						}
					}
					...
					foreach($this->new_lookup['section'] as $section_id_old => $section_id_new) {
						...
						if(isset($then_single->value)) {
							...
							foreach($parse_variables_repairable['section'] as $parse_variable) {
								...
								$then_single->value = str_replace('#' . $parse_variable . '(' . $section_id_old . ')', ($section_id_new != '') ? '#' . $parse_variable . '(' . $section_id_new . ')' : '', $then_single->value);
							}
						}
					}
				}
					...
					foreach($this->new_lookup['field'] as $field_id_old => $field_id_new) {
						...
						if(isset($else_single->value)) {
							...
							foreach($parse_variables_repairable['field'] as $parse_variable) {
								...
								$else_single->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ')', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ')' : '', $else_single->value);
								$else_single->value = str_replace('#' . $parse_variable . '(' . $field_id_old . ',', ($field_id_new != '') ? '#' . $parse_variable . '(' . $field_id_new . ',' : '', $else_single->value);
							}
						}
					}
					...
					foreach($this->new_lookup['section'] as $section_id_old => $section_id_new) {
						...
						if(isset($else_single->value)) {
							...
							foreach($parse_variables_repairable['section'] as $parse_variable) {
								...
								$else_single->value = str_replace('#' . $parse_variable . '(' . $section_id_old . ')', ($section_id_new != '') ? '#' . $parse_variable . '(' . $section_id_new . ')' : '', $else_single->value);
							}
						}
					}
				}
