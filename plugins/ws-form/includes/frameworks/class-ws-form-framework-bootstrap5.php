	...
	class WS_Form_Config_Framework_Bootstrap_5 {
		...
		public static function get_framework_config() {
			...
			return array(
				...
				'label_position_inside_class'	=>	'form-floating',
				...
				'tabs' => array(
					...
					'public' => array(
						...
						'mask_single'		=>	'<li class="nav-item" role="presentation"#attributes><a class="nav-link" href="#href" data-toggle="tab" role="tab">#label</a></li>',
						'activate_js'		=>	"var wsf_bs_tab_el = document.querySelector('#form ul.nav-tabs').getElementsByTagName('li')[#index].getElementsByTagName('a')[0]; var wsf_bs_tab = new bootstrap.Tab(wsf_bs_tab_el); wsf_bs_tab.show();",
