...
function elegantbakerytheme_init() {
    $labels = array(
        ...
        'singular_name'         => _x( 'Event', 'Post type singular name', 'elegantbakerytheme' ),
        'menu_name'             => _x( 'Events', 'Admin Menu text', 'elegantbakerytheme' ),
        'name_admin_bar'        => _x( 'Event', 'Add New on Toolbar', 'elegantbakerytheme' ),
        ...
        'featured_image'        => _x( 'Event Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'elegantbakerytheme' ),
        ...
        'archives'              => _x( 'Event archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'elegantbakerytheme' ),
